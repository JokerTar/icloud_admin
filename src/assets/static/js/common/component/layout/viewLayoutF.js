Vue.component("view-layout-f",{
    ...
    methods:{
        ...
        back:function () {
            ...
            if (mark == "permitCompEc") {
                window.location.href = "/ec/permit/comp";
            } else if (mark == "permitCompRf") {
                window.location.href = "/rf/permit/comp";
            }else{
