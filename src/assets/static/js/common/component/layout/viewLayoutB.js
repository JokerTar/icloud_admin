Vue.component("view-layout-b",{
            ...
            var leftMenus = this.menus.filter(function(menu){
                ...
                if(isLeft==true){
                    var hasView = self.menus.filter(function(menuL){
                        return menuL.parentCode == menu.resCode;
                    });
    ...
    methods:{
        ...
        back:function () {
            ...
            if(mark=="receive"){
                window.location.href = "/ec/credit/receiveList";
            }else if(mark=="first"){
                window.location.href = "/ec/credit/firstList";
            }else if(mark=="review"){
                window.location.href = "/ec/credit/reviewList";
            }else if(mark=="sign"){
                window.location.href = "/ec/credit/signList";
            }else if(mark=="makeBill"){
                window.location.href = "/ec/credit/makebill";
            }else if(mark=="loanTrial"){
                window.location.href = "/ec/credit/loantrial";
            }else if(mark=="pending"){
                window.location.href = "/ec/credit/pending";
            }else if(mark=="lending"){
                window.location.href = "/ec/credit/lending";
            }else if(mark=="success"){
                window.location.href = "/ec/credit/success";
            }else if(mark=="apply"){
                window.location.href = "/ec/credit/apply";
            }else if(mark=="asset"){
                window.location.href = "/ec/asset/pool";
            }else if(mark=="sealed"){
                window.location.href = "/ec/asset/sealed";
            }else if(mark=="issued"){
                window.location.href = "/ec/asset/issued";
            }else if(mark=="invest"){
                window.location.href = "/ec/asset/invest";
            }else if(mark=="assetSellReview"){
                window.location.href = "/ec/ecbiz/assetSellReview";
            }else if(mark=="factPlatformFirstInspection"){
                window.location.href = "/ec/capitalRouting/factPlatformFirstInspection";
            }else if(mark=="factPlatformReview"){
                window.location.href = "/ec/capitalRouting/factPlatformReview";
            }
